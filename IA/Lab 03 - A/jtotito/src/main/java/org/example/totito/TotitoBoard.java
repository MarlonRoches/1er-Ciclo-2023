package org.example.totito;

import org.example.adapter.Board;
import org.example.adapter.Piece;
...
public class TotitoBoard implements Board<Integer> {
    ...
    private boolean checkPosition(int p0, int p1, int p2){
        return position[p0] == position[p1] && position[p2] == position[p2] && position[p0] != TotitoPiece.E;
    }
